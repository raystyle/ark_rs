...
| 2026-09-20 | `docs/diary/2026-09-20-ledger命令族集成REQ-0015.md` | ledger 命令族集成（REQ-0015 签名道与双族命令）、封版 v1.5.0 |
| 2026-09-19 | `docs/diary/2026-09-19-独立分发域集成REQ0013.md` | 独立分发域集成（REQ-0013 catalog 节键与解析下载两面接线）、封版 v1.4.2 |
